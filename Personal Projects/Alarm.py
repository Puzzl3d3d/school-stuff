...
time_to_stop = input("Input alarm time (hh:mm): ")
print("Started alarm")
while True:
    time.sleep(5)
    current_time = now.strftime("%H:%M")
    print(str(current_time)[:5], time_to_stop.strip(), time_to_stop.strip() == str(current_time)[:5])
    if str(current_time)[:5] == time_to_stop.strip():
        set_volume(50)
        ...
        winsound.Beep(2500, 500)
        break
print("Alarm successfully triggered.")
